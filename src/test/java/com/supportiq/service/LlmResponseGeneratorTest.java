...
public class LlmResponseGeneratorTest {
    ...
    void testValidResponseGeneration() {
        ...
        mockJsonResponse(
                "{ \"relevance_score\": 0.9, \"selected_candidate_index\": 0, \"response\": \"Your package is on the way.\" }");
    ...
    void testLowRelevanceScoreReturnsFallback() {
        LlmResponseGenerator generator = createDefaultGenerator();
        mockJsonResponse(
                "{ \"relevance_score\": 0.5, \"selected_candidate_index\": 0, \"response\": \"Your package is on the way.\" }");
    ...
    void testUncertainIntentIncreasesThreshold() {
        ...
        mockJsonResponse(
                "{ \"relevance_score\": 0.75, \"selected_candidate_index\": 0, \"response\": \"Your package is on the way.\" }");
    ...
    void testInvalidCandidateIndexReturnsFallback() {
        LlmResponseGenerator generator = createDefaultGenerator();
        mockJsonResponse(
                "{ \"relevance_score\": 0.9, \"selected_candidate_index\": 5, \"response\": \"Your package is on the way.\" }"); // 5
                                                                                                                                 // is
                                                                                                                                 // out
                                                                                                                                 // of
                                                                                                                                 // bounds
        ...
        mockJsonResponse(
                "{ \"relevance_score\": 0.9, \"selected_candidate_index\": -2, \"response\": \"Your package is on the way.\" }"); // -2
                                                                                                                                  // is
                                                                                                                                  // invalid
        String response2 = generator.generateResponse(new CustomerMessage("Where is my stuff?"),
                new Intent(IntentTaxonomy.DELIVERY_AND_TRACKING, "TRACKING_NOT_UPDATED", 0.95, false),
                createMockEvidence());
        assertEquals(LlmResponseGenerator.FALLBACK_RESPONSE, response2);
    }
    ...
    void testInvalidScoreIsClamped() {
        LlmResponseGenerator generator = createDefaultGenerator();
        mockJsonResponse(
                "{ \"relevance_score\": 1.5, \"selected_candidate_index\": 0, \"response\": \"Your package is on the way.\" }"); // score
                                                                                                                                 // >
                                                                                                                                 // 1
        ...
        mockJsonResponse(
                "{ \"relevance_score\": -0.5, \"selected_candidate_index\": 0, \"response\": \"Your package is on the way.\" }"); // score
                                                                                                                                  // <
                                                                                                                                  // 0
        String response2 = generator.generateResponse(new CustomerMessage("Where is my stuff?"),
                new Intent(IntentTaxonomy.DELIVERY_AND_TRACKING, "TRACKING_NOT_UPDATED", 0.95, false),
    ...
    void testPromptInjectionInCustomerMessageIsHandled() {
        ...
        String response = generator.generateResponse(msg,
                new Intent(IntentTaxonomy.DELIVERY_AND_TRACKING, "TRACKING_NOT_UPDATED", 0.95, false),
                createMockEvidence());
        assertEquals("Your package is on the way.", response);
    }
    ...
    void testPromptInjectionInHistoricalMessageIsHandled() {
        ...
        String response = generator.generateResponse(new CustomerMessage("Where is my stuff?"),
                new Intent(IntentTaxonomy.DELIVERY_AND_TRACKING, "TRACKING_NOT_UPDATED", 0.95, false), evidence);
        assertEquals("Your package is on the way.", response);
    }
